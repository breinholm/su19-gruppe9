...
namespace Galaga_Exercise_3.GalagaStates {
    public class GamePaused: IGameState {
        ...
        private GamePaused() {
            resumeGamePos = new Vec2F(0.55f,0.677f);
            mainMenuPos = new Vec2F(0.55f,0.527f);
            ...
            menuButtons = new[] {
                ...
                new Text("Main Menu", new Vec2F(0.40f, 0.35f), buttonSize),
                new Text("Resume", new Vec2F(0.40f, 0.50f), buttonSize)
            };
            activeMenuButton = 1;
